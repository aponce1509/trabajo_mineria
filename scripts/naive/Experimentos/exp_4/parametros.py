...
PAHT_OUTPUT = "scripts/naive/Experimentos/exp_4"

# Descripción del exp:
# Experimento 4:
# Muy pocas variables para ver si saltan warnings


features_keep = ['respondent_id', 'h1n1_knowledge', 'doctor_recc_h1n1',
    'health_worker']
features_drop = None
features_keep_sea = ['respondent_id', 'h1n1_knowledge',
    'doctor_recc_seasonal', 'health_worker']
